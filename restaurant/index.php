...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">The Summer Bear</a>
                    </div>
        ...
        <div id="top" class="starter_container bg">
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="top-title"> The Summer Bear</h2>
       ...
       <!-- ============ Pricing  ============= -->
        ...
        <section id ="beer" class="description_content">
            <div  class="beer background_content">
               <div class="transbox"><h1 >Great <span>Place</span> to enjoy</h1></div> 
            </div>
            <div class="text-content container"> 
                <div class="col-md-5">
                   <div class="img-section">
                ...
                <div class="col-md-6 col-md-offset-1">
                    ...
                    <p class="desc-text">Here at The Summer Bear we’re all about the love of beer. New and bold flavors enter our doors every week, and we can’t help but show them off. While we enjoy the classics, we’re always passionate about discovering something new, so stop by and experience our craft at its best.</p>
                </div>
            </div>
        </section>
       ...
       <!-- ============ Our Bread  ============= -->
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-6 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 ">
                                                <!-- Send Button -->
                                                <button style="background-color:#C5C5C5;" type="submit" id="submit" name="submit" class="text-center form-btn form-btn" disabled>Reserve</button> 
                                            </div>
            ...
            <div class="text-content container"> 
                <div class="col-md-6">
                    ...
                    <ul class="social_icons">
                        ...
                        <li><a class="fa fa-facebook-official  color_animation" href="#" target="_blank"></a></li>
                        <li><a class="fa fa-snapchat  color_animation" href="#" target="_blank"></a></li>
        ...
        <section id="contact">
            <div class="map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3026.5848193297875!2d-111.88756188447536!3d40.66108157933738!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87528a2115331caf%3A0x111a3a088af0882f!2s244+E+Myrtle+Ave%2C+Murray%2C+UT+84107!5e0!3m2!1sen!2sus!4v1491875064764" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="contact-form">
                                ...
                                <form id="contact-us" method="post" action="contact.php">
                                    ...
                                    <div class="relative fullwidth col-xs-12">
                                        <!-- Send Button -->
                                        <button style="background-color:#C5C5C5;" type="submit" id="submit" name="submit" class="form-btn" disabled>Send Message</button> 
        ...
        <footer class="sub_footer">
            <div class="container">
                <div class="col-md-4"><p class="sub-footer-text text-center">&copy; The Summer Bear <?php echo date('Y') ?>  </p></div>
                <div class="col-md-4"><p class="sub-footer-text text-center">Back to <a href="#top">TOP</a></p>
                </div>
                <div class="col-md-4"><p class="sub-footer-text text-center">Built With Care By <a href="http://anthonybible.com" target="_blank">Anthony Bible</a></p></div>
            </div>
        </footer>
