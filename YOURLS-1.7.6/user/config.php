...
define( 'YOURLS_DB_PASS', '468DpDqFATtNxURNp7U' );
...
define( 'YOURLS_SITE', 'https://abible.co' );
...
define( 'YOURLS_COOKIEKEY', 'U%1$v8)$zAqvk]_~DU2[w~GW|OY{L1vtd@(Tt1UE' );

/** Username(s) and password(s) allowed to access the site. Passwords either in plain text or as encrypted hashes
 ** YOURLS will auto encrypt plain text passwords in this file
 ** Read http://yourls.org/userpassword for more information */
$yourls_user_passwords = array(
	'abible' => 'phpass:!2a!08!PiFDmzW.p9.29vhmxED6..B9APnFR249IqJTKhmM.IP3jEEuZXWCW' /* Password encrypted by YOURLS */ ,
	// 'username2' => 'password2',
